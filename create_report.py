...
story.append(Paragraph(
    "In this project, I analyzed the Superstore sales data to understand sales patterns "
    "and tried to predict monthly sales using machine learning. "
...
story.append(Paragraph(
    ...
    "score of 0.5511 and an RMSE of 16,094.10. The Random Forest model "
    "performed better than Linear Regression. Adding time and seasonal information helped the  model predict sales better.",
    body_style
))

story.append(Paragraph(
    "The model could be improved in the future by adding more useful features "
    "such as discounts, customer segments and previous months' sales.",
    body_style
))
